...
public class HttpRequestUtilsTest {
	...
	public void splitUrl() {
		String line = "/user/create";
		String url[] = HttpRequestUtils.splitUrl(line);
		assertThat("/user/create", is(url[0]));
	}
	
	@Test
	public void splitUrl_parameter() {
		String line = "/user/create?userId=javajigi&password=password&name=%EB%B0%95%EC%9E%AC%EC%84%B1&email=javajigi%40slipp.net";
		String url[] = HttpRequestUtils.splitUrl(line);
		assertThat("/user/create", is(url[0]));
	}
}
